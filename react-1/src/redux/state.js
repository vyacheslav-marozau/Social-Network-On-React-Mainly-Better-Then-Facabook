...
let store = {
    ...
    dispatch(action) { //type: 'ADD-POST';
        if (action.type === 'ADD-POST') {
            ...
            this._state.profilePage.newPostText = '';
            this._callSubscriber(this._state);
        } else if (action.type === 'UPDATE-NEW-POST-TEXT') {     //type: = 'UPDATE-NEW-POST-TEXT'
            this._state.profilePage.newPostText = action.newText;
            this._callSubscriber(this._state);
        } else if (action.type === 'ADD-MESSAGE') {        //type: = 'ADD-MESSAGE'
            let body = this._state.dialogsPage.newMessageText;
            this._state.dialogsPage.messages.push({id: this._state.dialogsPage.currentId,
                                                   message: body,
                                                   sender: 'Pastor J'});
            this._state.dialogsPage.currentId++;
            this._state.dialogsPage.newMessageText = '';
            this._callSubscriber(this._state);
        } else if (action.type === 'UPDATE-NEW-MESSAGE-TEXT') {          //type: = 'UPDATE-NEW-MESSAGE-TEXT'
